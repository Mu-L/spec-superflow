...
```bash
npx --yes --package spec-superflow@0.9.0 ssf state set <change-dir> dp_1_result "confirmed: <one-line summary>"
npx --yes --package spec-superflow@0.9.0 ssf state set <change-dir> dp_1_timestamp $(date -u +%Y-%m-%dT%H:%M:%SZ)
```
