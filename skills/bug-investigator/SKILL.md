...
3+ failed fixes = architectural problem. Each fix revealing new problems elsewhere = wrong architecture. Record: `npx --yes --package spec-superflow@0.9.0 ssf state set <change-dir> dp_5_result <decision>`. Discuss with user before attempting more fixes.
